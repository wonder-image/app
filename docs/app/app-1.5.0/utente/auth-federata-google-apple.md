...
- Schema tabella runtime: `1.5.0/build/table/user.php` -> `$TABLE->AUTH_FEDERATED`
- Configurazione chiavi backend: `1.5.0/build/src/backend/app/config/credentials/index.php`
