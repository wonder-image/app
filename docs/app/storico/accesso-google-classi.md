...
{% hint style="warning" %}
📁 **Riferimento classi — funzionalità non collegata.** Le classi federate
esistono ma **non sono agganciate** ai flussi di login correnti. Vedi
[Auth federata Google / Apple](../concetti/utenti/auth-federata.md) per lo stato.
{% endhint %}
...
Per recupero credenziali: [Google Sign-In OAuth](../servizi/configurazione/google-sign-in-oauth.md)
