...
* [App](README.md)
  ...
  * [Moduli](modules/README.md)
    * [Sistema Moduli](modules/module-system.md)
    * [Contratto Modulo](modules/module-contract.md)
    * [Manifest Modulo](modules/module-manifest.md)
  * [Agenti AI](ai/README.md)
    * [Cascade file-level](ai/cascade.md)
    * [Sezione `ai` in module.json](ai/manifest.md)
