...
* [Cos'è wonder-image/app](README.md)
* [Architettura in 5 minuti](introduzione/architettura.md)
* [Glossario](introduzione/glossario.md)
* [Avvio rapido](introduzione/avvio-rapido.md)
...
* [Moduli](concetti/moduli/README.md)
  ...
  * [Manifest module.json](concetti/moduli/manifest.md)
...
* [Render delle tabelle](concetti/tabelle/README.md)
  ...
  * [Appendice: Table legacy](concetti/tabelle/legacy.md)
* [Utenti e Permessi](concetti/utenti/README.md)
  * [Builder permessi (Area / Permission)](concetti/utenti/permessi.md)
  * [Gestione utenti (backend / API)](concetti/utenti/gestione-utenti.md)
  * [Permessi client e verifica email](concetti/utenti/permessi-client.md)
...
* [Indice servizi](servizi/README.md)
  ...
  * [Configurazione](servizi/configurazione/README.md)
    ...
    * [Google Search Console](servizi/configurazione/google-search-console.md)
    * [Fatture in Cloud](servizi/configurazione/fatture-in-cloud.md)
    * [Brevo](servizi/configurazione/brevo.md)
    * [Klaviyo](servizi/configurazione/klaviyo.md)
  * [Google Tag Manager](servizi/google-tag-manager/configurazione.md)
    * [iubenda](servizi/google-tag-manager/iubenda.md)
    * [Google Analytics](servizi/google-tag-manager/google-analytics.md)

## Proposte (non implementate)

* [Sistema moduli — progetto](proposte/module-system-project.md)
* [Roadmap PHP 8.4 / Symfony 8](proposte/roadmap-php84-symfony8.md)

## Storico

* [Versione <1.5.0](storico/versione-1.5.0.md)
* [Migrazione HTTP backend](storico/migrazione-http-backend.md)
* [Refactor globale legacy](storico/refactor-globale-legacy.md)
* [Accesso con Google (classi legacy)](storico/accesso-google-classi.md)
* [Accesso con Apple (classi legacy)](storico/accesso-apple-classi.md)
* [Consent GDPR (PHP legacy)](storico/consent-gdpr-php.md)
