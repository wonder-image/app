    ...
    class Swiper extends Media {
        ...
        protected function renderMedia($class): string
        {
            ...
            foreach ($items as $item) {
                ...
                $this->imagePriority = $i === 0 && (bool) $class->getSchema('image-priority');
            ...
            if ($thumbs) {
                ...
                $html .= "<div id='$id-thumbs' data-swiper-layout='$thumbLayoutKey' class='swiper w-100 o-hidden mt-2'><div class='swiper-wrapper'>$thumbSlides</div></div>";
            }
