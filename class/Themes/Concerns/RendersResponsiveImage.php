<?php
    ...
    /**
     * Motore immagine responsive theme-neutral: <picture>/<img> con webp + srcset + sizes.
     * L'unico punto specifico del tema è l'hook applyThemeClasses(), che ogni renderer
     * sovrascrive per aggiungere le proprie classi CSS (lib per Wonder, utility per Bootstrap).
     */
    trait RendersResponsiveImage
    {
        use HasSchema;
        use HasAttributes;
        ...
        public function renderResponsiveImage($class): string
        {
        ...
        /** Hook specifico del tema: aggiunge le classi CSS all'elemento in base allo schema. */
