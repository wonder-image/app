<?php
    ...
    class MakeResource extends Command {
        ...
        protected function template($className, $namespace): string
        {
            ...
            $template .= "use Wonder\\App\\ResourceSchema\\FormSchema;\n";
            ...
            $template .= "use Wonder\\App\\ResourceSchema\\TableSchema;\n";
            $template .= "\n";
            ...
            $template .= "    {\n";
            $template .= "        return FormSchema::for(static::class)\n";
            $template .= "            ->toArray();\n";
            $template .= "    }\n";
            $template .= "\n";
            $template .= "    public static function tableSchema(): array\n";
            $template .= "    {\n";
            $template .= "        return TableSchema::for(static::class)\n";
            $template .= "            ->toArray();\n";
            $template .= "    }\n";
            $template .= "\n";
            $template .= "    public static function pageSchema(): array\n";
            $template .= "    {\n";
            $template .= "        return PageSchema::for(static::class)->toArray();\n";
            $template .= "    }\n";
            $template .= "\n";
            $template .= "    public static function apiSchema(): array\n";
            $template .= "    {\n";
            $template .= "        return ApiSchema::for(static::class)\n";
            $template .= "            ->toArray();\n";
            $template .= "    }\n";
            $template .= "\n";
            $template .= "    public static function permissionSchema(): array\n";
            $template .= "    {\n";
            ...
            $template .= "    }\n";
            $template .= "\n";
            $template .= "    public static function navigationSchema(): array\n";
            $template .= "    {\n";
