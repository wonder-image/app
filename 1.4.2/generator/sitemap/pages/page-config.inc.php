<?php // This file is protected by copyright law and provided under license. Reverse engineering of this file is strictly prohibited.
																									...
																									<?php $xz = 'img';?>
																									<input type="checkbox" name="imginfo" <?php echo $grab_parameters['xs_imginfo']?'checked':''?> id="imginfo1" onclick="sWtCFebJTmez('sm_img_div')"><label for="imginfo1">
																									...
																									<?php $xz = 'rss';?>
																									<input type="checkbox" name="rssinfo" <?php echo $grab_parameters['xs_rssinfo']?'checked':''?> id="rssinfo1" onclick="sWtCFebJTmez('sm_rss_div')"><label for="rssinfo1">
